...
public class PostManController {
	...
	public String postDelivery(CustomerModel customerModel) {
		return "고객명: " + customerModel.getCustomer_name() + " 배송지(주소): " + customerModel.getCustomer_addr() + " 연락처: " + customerModel.getCustomer_phone() + " 기타사항: " + customerModel.getCustomer_etc();
	}
}
